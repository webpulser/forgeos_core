  ...
  namespace :fixtures do
    ...
    task :load => :environment do
      ...
      if ENV['FIXTURES']
        ...
        puts "usage: rake forgeos_core:fixtures:load FIXTURES=table_name1,table_name2;"
        exit
      end
    ...
    task :extract => :environment do
      ...
      if ENV['FIXTURES']
        ...
        puts "usage: rake forgeos_core:fixtures:extract FIXTURES=table_name1,table_name2;"
        exit
      end
